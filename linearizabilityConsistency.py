...
class LinearizabilityConsistency(Channel): # inherit from Channel
    ...
    def multicast(self, conn, message, header, client_id):
        ...
        for to_pid in self.process_info.keys():
            ...
            m = LinearizabilityConsistencyMessage(self.pid, to_pid, id, client_id, message, header)
    ...
    def recvReplica(self, data):
        ...
        if data:
            ...
            # total order multicast
                ...
                m = LinearizabilityConsistencyMessage(from_id, to_id, id, client_id, message, "w")
